...
def main():
    ...
    # предсказываем моделью ответы для этих данных, записываем ответы на диск в predicted_labels.csv файл,
    # выводим в metrics.json необходимые метрики на этом датасете.
    ...
    np.savetxt('./predicted_labels.csv', np.array(predicted_lst, dtype=int), delimiter=',')
